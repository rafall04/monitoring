    ...
    <div className="flex h-screen">
      ...
      >
        ...
        <nav className="flex-1 space-y-1 overflow-y-auto px-2">
          {user.role === 'member' ? (
            // Members are hotspot end-users — their world is the account
            // center (/akun = hotspot+kuota+tiket+WA) plus web-profile basics.
            <>
              {item('/akun', 'Akun Saya', 'hotspot')}
              {item('/profile', 'Profil & Keamanan', 'user')}
            </>
          ) : (
            <>
...
const NAV_ICONS = {
  ...
  user: <I><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></I>,
